    ...
    return (
        <section id="home" className={`relative min-h-[100vh] flex items-center justify-center text-white text-center overflow-hidden`} style={{ backgroundColor: COLORS.PRIMARY_DARK }}>
            ...
            <div className="relative z-10 p-4 max-w-5xl mx-auto">
                ...
                <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black mb-6 leading-tight tracking-tight" style={{ textShadow: '4px 4px 8px rgba(0,0,0,0.5)', color: COLORS.PRIMARY }}>
                    {heroTitle}
                </h1>
                <p className="text-lg italic mb-6" style={{ color: COLORS.PRIMARY_DARK }}>
                    {heroTagline}
                </p>
                <p className="text-sm sm:text-md mb-8 max-w-2xl mx-auto" style={{ color: COLORS.TEXT_DARK }}>
