      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="bg-gradient-to-br from-white via-gray-50 to-indigo-50 p-8 rounded-2xl shadow-lg border-l-4 border-indigo-300 border border-gray-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
            >
              <p className="text-indigo-700 mb-6 italic text-lg leading-relaxed">"{testimonial.message}"</p>
              <div>
