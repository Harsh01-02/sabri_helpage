    ...
    <section className="py-20 md:py-28" style={{ backgroundColor: COLORS.BG_LIGHT_GRAY }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div id="about" className='order-first md:order-last'>
                ...
                <h2 className={`text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-6`} style={{ color: COLORS.PRIMARY_DARK }}>
                    Shaping Lives Through <br/> Compassionate Action.
                </h2>
                <p className="text-base sm:text-lg leading-relaxed mb-8" style={{ color: COLORS.TEXT_DARK }}>
