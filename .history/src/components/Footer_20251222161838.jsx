            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12">
                    ...
                    <div className={`${activeTab === 'quick-links' || !activeTab ? 'block' : 'hidden'} lg:block flex-1`}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 lg:gap-x-8 gap-y-4 mt-6">
                            ...
                            <ul className="space-y-3">
                                ...
                                <li><a href="/privacy" className="flex items-center text-white hover:text-gray-200 transition duration-200">Privacy</a></li>
                ...
                <div className="pt-6 border-t border-white/30 mt-8 lg:mt-12">
                    ...
                    <div className="text-center">
                        <p className="text-white text-sm mb-2">© {new Date().getFullYear()} Sabri Helpage. All rights reserved.</p>
