        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-5 lg:w-1/2 w-full lg:ml-auto lg:items-end flex flex-col">
                        ...
                        <div className="flex space-x-4 mt-2 justify-end w-full">
                ...
                <div className="pt-6 border-t border-white/30 mt-12">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 relative">
                        ...
                        {/* Copyright - exactly centered */}
                        <div className="order-1 md:order-2 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-max">
                            <p className="text-white text-sm">© {new Date().getFullYear()} Sabri Helpage. All rights reserved.</p>
                        </div>
                        {/* Footer Links */}
                        {/* Footer Links moved above, removed from here to avoid overlap */}
                    </div>
                </div>
            </div>
        </div>
