            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="pt-6 border-t border-white/30 mt-12">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        {/* Copyright and Footer Links Centered */}
                        <div className="w-full flex flex-col items-center justify-center md:flex-row md:justify-center">
                            <div className="flex items-center justify-center">
                                <p className="text-white text-sm text-center">© {new Date().getFullYear()} Sabri Helpage. All rights reserved.</p>
