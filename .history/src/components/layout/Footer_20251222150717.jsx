        ...
        <footer className="text-white pt-12 pb-8" style={{ backgroundColor: ACCENT_ORANGE }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12 mb-12">
                    ...
                    {/* Newsletter Section - shifted to far right and right-aligned */}
                    <div className="lg:w-96 w-full mt-10 lg:mt-0 lg:ml-auto lg:text-right flex flex-col items-center lg:items-end">
                        <div className="flex flex-col w-full lg:w-auto">
                            <h3 className="text-2xl font-bold mb-4 lg:text-right w-full">SabriHelpage</h3>
                            <p className="text-white mb-6 leading-relaxed lg:text-right w-full">
                                Dedicated to serving humanity through comprehensive welfare programs for the elderly, women, and children.
                            </p>
                            <h4 className="text-xl font-bold mb-2 lg:text-right w-full">Stay Updated</h4>
                        </div>
                        <p className="text-white mb-4 text-sm lg:text-right w-full">Subscribe to our newsletter for the latest impact stories.</p>
                        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2 w-full lg:justify-end">
                            <input
                                type="email"
