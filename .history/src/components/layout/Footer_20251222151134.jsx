        ...
        <footer className="text-white pt-12 pb-8" style={{ backgroundColor: ACCENT_ORANGE }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12 mb-12">
                    ...
                    {/* Newsletter Section - shifted to far right, content left-aligned */}
                    <div className="lg:w-96 w-full mt-10 lg:mt-0 lg:ml-auto flex flex-col items-center lg:items-end">
