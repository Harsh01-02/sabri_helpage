                ...
                <div className="pt-6 border-t border-white/30 mt-12">
                    <div className="grid grid-cols-3 items-center gap-4">
                        ...
                        <div className="flex space-x-4" style={{ marginLeft: '30%' }}>
                            <Link to="/about" className="text-white hover:text-gray-200 text-sm font-bold transition duration-300">About</Link>
                            <Link to="/terms" className="text-white hover:text-gray-200 text-sm font-bold transition duration-300">Terms</Link>
                            <Link to="/privacy" className="text-white hover:text-gray-200 text-sm font-bold transition duration-300">Privacy</Link>
                        </div>
                    </div>
                </div>
            </div>
