    ...
    <footer className="text-white pt-12 pb-6" style={{ backgroundColor: COLORS.PRIMARY }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-5 lg:w-1/2 w-full lg:ml-auto lg:items-end flex flex-col">
                        <div className="flex flex-col items-end w-full">
                            <h2 className="text-3xl font-bold mb-2">SabriHelpAge</h2>
                            <h3 className="text-xl font-bold mb-3 border-b-2 border-white pb-2 inline-block">Stay Updated</h3>
                        </div>
                        <p className="text-white/90 mb-8 text-right">
                            Dedicated to serving humanity through comprehensive welfare programs for the elderly, women, and children.
                        </p>
                        <div className="mb-8 flex flex-col items-end w-full">
                            <p className="text-white/90 mb-4 mt-4 text-right">Subscribe to our newsletter for the latest impact stories.</p>
                ...
                <div className="pt-6 border-t border-white/30 mt-12">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 relative">
                        ...
                        {/* Copyright - exactly centered, links at center right */}
                        <div className="order-1 md:order-2 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-max flex items-center">
                            <p className="text-white text-sm whitespace-nowrap">© {new Date().getFullYear()} Sabri Helpage. All rights reserved.</p>
                            <div className="flex space-x-6 ml-8">
                                <a href="/about" className="text-white font-bold hover:text-gray-200 text-base transition duration-300">About</a>
                                <a href="/terms" className="text-white font-bold hover:text-gray-200 text-base transition duration-300">Terms</a>
                                <a href="/privacy" className="text-white font-bold hover:text-gray-200 text-base transition duration-300">Privacy</a>
                            </div>
                        </div>
                        
                        {/* Footer Links */}
                        <div className="flex space-x-4 order-3 justify-center w-full">
                            <a href="/about" className="text-white font-bold hover:text-gray-200 text-base transition duration-300">About</a>
                            <a href="/terms" className="text-white font-bold hover:text-gray-200 text-base transition duration-300">Terms</a>
                            <a href="/privacy" className="text-white font-bold hover:text-gray-200 text-base transition duration-300">Privacy</a>
                        </div>
