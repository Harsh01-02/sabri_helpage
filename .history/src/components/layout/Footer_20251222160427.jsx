            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12 mb-12">
                    ...
                    <div className="flex-1 min-w-[220px]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-0 gap-y-3 mt-6">
                            {/* Column 1 */}
                    ...
                    {/* Newsletter Section - reduced width and pushed right */}
                    <div className="w-full mt-10 lg:mt-0 lg:w-60 lg:ml-auto lg:mr-0 flex flex-col items-center lg:items-end">
                        <div className="flex flex-col w-full lg:w-auto">
                            <h3 className="text-2xl font-bold mb-4 w-full">SabriHelpage</h3>
                            <p className="text-white mb-6 leading-relaxed w-full">
                                Dedicated to serving humanity through comprehensive welfare programs for the elderly, women, and children.
                            </p>
                            <h4 className="text-xl font-bold mb-2 w-full">Stay Updated</h4>
                        </div>
                        <p className="text-white mb-4 text-sm w-full">Subscribe to our newsletter for the latest impact stories.</p>
                ...
                {/* Bottom Section */}
                <div className="pt-6">
                    <div className="flex flex-col md:flex-row items-center justify-between w-full gap-4 relative" style={{position: 'relative'}}>
                        {/* Social Media Icons */}
                        ...
                        {/* Copyright Centered - absolutely centered */}
                        <div className="order-2 w-full flex justify-center items-center absolute left-1/2 top-1/2 md:static md:transform-none" style={{position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', minWidth: 'max-content'}}>
                            <span className="text-white text-sm">{new Date().getFullYear()} Sabri Helpage. All rights reserved.</span>
                        </div>
                        {/* Legal Links Right */}
                        <div className="flex flex-wrap items-center justify-center gap-6 order-3 md:w-auto md:ml-0 md:mr-0 mb-4 absolute" style={{left: '37.5%', transform: 'translateX(-37.5%)'}}>
                            <button onClick={() => onNavigate('about')} className="text-white font-bold hover:text-gray-200 transition duration-300 text-base">About</button>
                            <button onClick={() => onNavigate('terms')} className="text-white font-bold hover:text-gray-200 transition duration-300 text-base">Terms</button>
                            <button onClick={() => onNavigate('privacy')} className="text-white font-bold hover:text-gray-200 transition duration-300 text-base">Privacy</button>
                        </div>
                    </div>
                </div>
            </div>
