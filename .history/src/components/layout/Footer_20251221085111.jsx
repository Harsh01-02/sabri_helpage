                ...
                <div className="pt-6">
                    <div className="flex flex-col md:flex-row items-center justify-between w-full gap-4">
                        ...
                        <div className="flex flex-wrap items-center justify-center md:justify-end gap-4 order-3">
                            <a href="/about" className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">About</a>
                            ...
                            <a href="/privacy" className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">Privacy</a>
                        </div>
                    </div>
                </div>
            </div>
