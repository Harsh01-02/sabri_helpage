            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12 mb-12">
                    ...
                    <div className="flex-1 min-w-[220px]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-2 gap-y-3 mt-6">
                            {/* Column 1 */}
                ...
                <div className="pt-6">
                    <div className="flex flex-col md:flex-row items-center justify-between w-full gap-4 relative" style={{position: 'relative'}}>
                        ...
                        {/* Legal Links Right */}
                        <div className="flex flex-wrap items-center justify-center md:justify-center gap-4 order-3 md:w-auto md:ml-auto md:mr-16">
                            <button onClick={() => onNavigate('about')} className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">About</button>
                            <button onClick={() => onNavigate('terms')} className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">Terms</button>
                            <button onClick={() => onNavigate('privacy')} className="text-white hover:text-gray-200 transition duration-300 font-medium text-sm">Privacy</button>
                        </div>
                    </div>
                </div>
            </div>
