            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="pt-6">
                    <div className="flex flex-col md:flex-row items-center justify-between w-full gap-4 relative" style={{position: 'relative'}}>
                        ...
                        <div className="order-2 w-full flex items-center justify-center gap-10 absolute left-1/2 top-1/2 md:static md:transform-none" style={{position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', minWidth: 'max-content'}}>
