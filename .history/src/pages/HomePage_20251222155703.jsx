...
const HomePage = ({ onNavigate }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col h-full">
              <div
                className="p-8 md:p-12 rounded-3xl shadow-2xl h-full flex flex-col transition-all duration-500 hover:shadow-xl bg-gradient-to-br from-primary to-primary-dark"
              >
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <SectionTitle className="mb-16" style={{ color: COLORS.PRIMARY + ' !important' }}>Our Core Causes</SectionTitle>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-12 bg-white border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-sm font-bold uppercase tracking-widest mb-6" style={{ color: COLORS.PRIMARY }}>Our Supporters</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-center mb-12">
            <SectionTitle className="text-center" style={{ color: COLORS.PRIMARY + ' !important' }}>Our Stories</SectionTitle>
            <button 
