        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col h-full">
              <div
                className="p-10 md:p-14 rounded-3xl shadow-2xl h-full flex flex-col justify-between bg-[#B5574A]"
              >
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-white/90 mb-6">
                    Our Milestones
                  </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-12">
                    ...
                    <div 
                      key={idx} 
                      className="bg-[#8B3E35] p-6 rounded-2xl text-center transition-all duration-300 hover:bg-[#7A3529]"
                    >
                      <span className="block text-3xl md:text-4xl font-bold text-white mb-2">{stat.value}</span>
                      <span className="block text-xs font-bold text-white uppercase tracking-wide mt-2">{stat.label}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Watch Our Stories</span>
                    <span className="text-lg font-bold text-gray-900">Visit YouTube Channel</span>
                  </div>
                </div>
