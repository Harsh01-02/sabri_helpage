  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* Welcome + Body + Register Combined Box */}
        <div className="mb-16 mt-8 bg-white rounded-2xl shadow-lg border border-gray-200 p-10 text-center flex flex-col items-center">
          <h2 className="text-4xl font-bold mb-4" style={{ color: COLORS.PRIMARY }}>
            Welcome to Sabri Social Impact Club!
          </h2>
          <div className="h-1 w-24 mx-auto mb-8" style={{ backgroundColor: COLORS.PRIMARY }}></div>
          <div className="max-w-2xl mx-auto text-gray-700 leading-relaxed text-justify mb-8">
