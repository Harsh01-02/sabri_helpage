      ...
      <PageSection bg="white">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-2xl shadow-lg p-8 md:p-10 text-center" style={{ backgroundColor: COLORS.PRIMARY_PALE }}>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-3 font-sans" style={{ color: COLORS.PRIMARY_DARK, letterSpacing: '0.01em' }}>
              {getText('causeMentalTitle', 'Mental Health Awareness')}
            </h2>
            <p className="font-semibold italic mb-6 text-primary" style={{ color: COLORS.PRIMARY, fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
              {getText('causeMentalSubtitle', '“Breaking the silence”')}
            </p>
            <p className="text-lg text-gray-800 mb-4 leading-relaxed font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
              {getText(
                'causeMentalBody',
            ...
            <p className="text-gray-800 mb-8 leading-relaxed font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
              {getText(
                'causeMentalBody2',
      ...
      <PageSection bg="white">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-2xl shadow-lg p-8 md:p-10 text-center" style={{ backgroundColor: COLORS.PRIMARY_PALE }}>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4 font-sans" style={{ color: COLORS.PRIMARY_DARK, letterSpacing: '0.01em' }}>
              {getText('causeElderlyTitle', 'Elderly Care & Dignity')}
            </h2>
            <p className="text-lg text-gray-800 mb-6 leading-relaxed font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
              {getText(
                'causeElderlyBody',
          ...
          <div className="rounded-2xl shadow-lg p-8 md:p-10 text-center" style={{ backgroundColor: COLORS.PRIMARY_PALE }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
              <div className="bg-white p-6 rounded-xl border shadow-sm" style={{ borderColor: COLORS.PRIMARY_PALE }}>
                <h4 className="font-bold mb-2 text-lg" style={{ color: COLORS.PRIMARY_DARK, fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
                  {getText('causeGirlCard1Title', 'Hygiene & Dignity')}
                </h4>
                <p className="text-base text-gray-700 font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
