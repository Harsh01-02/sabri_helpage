    ...
    <div className="min-h-screen" style={{ backgroundColor: COLORS.BG_LIGHT_GRAY }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <div className="bg-gray-50 rounded-2xl shadow-sm border border-gray-200 py-14 px-6 md:px-10 flex flex-col items-center font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif', letterSpacing: '0.01em', minHeight: '420px' }}>
            <h2 className="text-2xl md:text-3xl font-bold text-primary mb-5 tracking-tight">Recognizing Exemplary Community Service</h2>
            <div className="text-base md:text-lg text-gray-700 text-center space-y-6 leading-relaxed">
              <p>
