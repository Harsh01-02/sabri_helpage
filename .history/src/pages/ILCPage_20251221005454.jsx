      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mb-16 mt-8 max-w-5xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif', letterSpacing: '0.01em' }}>
            <h2 className="text-2xl md:text-3xl font-semibold text-gray-700 mb-2 tracking-normal" style={{ color: COLORS.PRIMARY_PALE }}>
              <span className="block text-sm font-medium uppercase tracking-wide mb-1" style={{ color: COLORS.PRIMARY_PALE }}>Sabri Social Impact Club</span>
              <span className="block">Welcome to <span className="text-primary font-semibold" style={{ color: COLORS.PRIMARY }}>SSIC</span></span>
            </h2>
          ...
          <div className="space-y-4 text-gray-700">
            {[
              ...
              <div key={idx} className="flex gap-3 items-start">
                <span className="font-bold text-lg" style={{ color: COLORS.PRIMARY }}>›</span>
