...
const ILCPage = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      {/* Mission Section - Modern Card Grid */}
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[ 
            ...
            <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center font-sans min-h-[180px] justify-center hover:shadow-md transition-shadow">
              <span className="font-bold text-xl mb-4" style={{ color: COLORS.PRIMARY }}>›</span>
              <p className="leading-relaxed text-gray-700 text-center text-base">{mission}</p>
            </div>
          ))}
        </div>
      </div>
