      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="bg-white rounded-3xl shadow-xl p-12 border border-gray-100 flex flex-col items-center font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif', letterSpacing: '0.01em' }}>
            <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-6 tracking-tight">Honoring Unsung Heroes</h2>
            <div className="text-lg md:text-xl text-gray-800 text-center space-y-8 leading-relaxed">
              <p className="mb-0">
