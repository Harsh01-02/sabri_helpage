...
What started as a sincere effort has now become a dependable source of support for many. Sabri Helpage is dedicated to making society more knowledgeable, emotionally strong, and welcoming, one life at a time.
          ...
          <div className="max-w-4xl mx-auto mt-16">
            ...
            <div className="space-y-12">
              <div className="bg-white rounded-xl shadow p-6 md:p-8 flex items-start gap-6">
                <img
                  src={require("../assets/about/sample-profile.svg")}
                  alt="Aarti BR Singh"
                  className="w-16 h-16 rounded-full object-cover border border-gray-300 shadow-sm mt-1"
                  style={{ flexShrink: 0 }}
                />
                <div>
