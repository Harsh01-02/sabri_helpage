    ...
    <div className="min-h-screen" style={{ backgroundColor: COLORS.BG_LIGHT_GRAY }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="bg-gray-50 rounded-2xl shadow-sm border border-gray-200 p-10 md:p-12 flex flex-col items-center font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif', letterSpacing: '0.01em' }}>
