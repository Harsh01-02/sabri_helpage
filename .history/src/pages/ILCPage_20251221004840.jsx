  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* Welcome + Body + Register Combined Box - Improved Design */}
        <div className="mb-16 mt-8 w-full max-w-3xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 p-0 flex flex-col items-center overflow-hidden">
          {/* Header Gradient Bar */}
          <div className="w-full h-3 bg-gradient-to-r from-[#e0e7ff] via-[#f3f4f6] to-[#e0e7ff]" />
          <div className="w-full px-10 py-10 flex flex-col items-center">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight text-gray-900" style={{ color: COLORS.PRIMARY }}>
              Welcome to Sabri Social Impact Club
            </h2>
            <div className="h-1 w-16 mb-8 rounded-full" style={{ backgroundColor: COLORS.PRIMARY }}></div>
            <div className="max-w-xl mx-auto text-gray-600 leading-relaxed text-center mb-8 text-lg">
              <p className="mb-4">
              ...
              <p>
                The Sabri Social Impact Club wants to see a future where people collaborate to uplift vulnerable communities, empower youth, support girls, and strengthen India's environmental and social welfare systems.
              </p>
            </div>
            <button 
              onClick={toggleModal}
