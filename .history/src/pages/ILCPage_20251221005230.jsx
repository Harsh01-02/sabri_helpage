      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mb-16 mt-8 max-w-5xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif', letterSpacing: '0.01em' }}>
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-2 tracking-tight" style={{ color: COLORS.PRIMARY }}>
              <span className="block text-base font-semibold uppercase tracking-widest mb-2" style={{ color: COLORS.PRIMARY_PALE }}>Sabri Social Impact Club</span>
              <span className="block">Welcome to <span className="text-primary" style={{ color: COLORS.PRIMARY }}>SSIC</span></span>
            </h2>
