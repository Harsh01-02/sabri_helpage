        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col h-full">
            <div className="p-12 md:p-16 rounded-3xl shadow-2xl h-full flex flex-col justify-between bg-[#B5574A]">
              <div>
                <p className="text-[11px] font-bold uppercase tracking-widest text-white/90 mb-8">
                  Our Milestones
                </p>

                <h3 className="text-4xl sm:text-5xl lg:text-[3.2rem] font-bold text-white leading-[1.15]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-16">
                {statsSection.items.map((stat, idx) => (
                  <div 
                    key={idx} 
                    className="bg-[#8B3E35] p-7 rounded-2xl text-center transition-all duration-300 hover:bg-[#7A3529]"
                  >
