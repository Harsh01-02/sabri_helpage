  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12 mt-8 bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-16 text-gray-700 leading-relaxed text-justify">
