...
const HomePage = ({ onNavigate }) => {
  ...
  // Fallback data for sections not in the API yet
  const supporters = [
  ...
  return (
    <>
        ...
        <section className="relative h-[600px] md:h-[700px] flex items-center justify-center text-center overflow-hidden bg-black">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {heroSection.cta && (
                <button
                  onClick={() => onNavigate(heroSection.cta.targetSlug)}
                ...
                <div key={idx} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-500 transform hover:-translate-y-2">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      <button 
                        onClick={() => onNavigate(cause.title.toLowerCase().replace(/\s+/g, '-'))} 
      ...
      {/* Supporters Section - Temporary Hardcoded */}
      ...
      {/* Stories Section - Using Dynamic Data when available, fallback to hardcoded */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {(storiesSection?.items && storiesSection.items.length > 0 ? storiesSection.items : newsItems).map((story, idx) => (
              <div key={idx} className="group cursor-pointer" onClick={() => onNavigate('blog')}>
