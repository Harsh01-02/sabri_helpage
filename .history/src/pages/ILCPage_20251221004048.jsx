  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* Modern Minimal Welcome & Info Boxes */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 mt-8">
          {/* Welcome Box */}
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center justify-center text-center font-sans">
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4 tracking-tight" style={{ color: COLORS.PRIMARY }}>
              Welcome to Sabri Social Impact Club!
            </h2>
            <div className="h-1 w-16 mx-auto mb-4" style={{ backgroundColor: COLORS.PRIMARY }}></div>
          </div>
          {/* SSIC Vision Box */}
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center justify-center text-center font-sans">
