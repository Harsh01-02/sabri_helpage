  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: COLORS.BG_LIGHT_GRAY }}>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* Welcome + Body + Register Combined Box - CausesPage Theme, full width, pro heading */}
        <div className="mb-16 mt-8 max-w-5xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif', letterSpacing: '0.01em' }}>
            <h2 className="text-xl md:text-2xl font-sans font-semibold mb-4 tracking-wide text-center" style={{ color: COLORS.PRIMARY, fontFamily: 'Inter, Segoe UI, Arial, sans-serif', letterSpacing: '0.01em' }}>
              Welcome to <span className="font-bold" style={{ color: COLORS.PRIMARY, fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>SSIC</span>
            </h2>
            ...
            <div className="w-full rounded-xl mb-4" style={{ background: 'linear-gradient(90deg, #ffe4ef1a 0%, #fff 100%)' }}>
              <p className="text-base text-gray-700 text-center leading-relaxed py-4 font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
                <span className="font-bold" style={{ color: COLORS.PRIMARY, fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>SSIC</span> is the vision of Sabri Helpage to create a caring and socially responsible community where businesses and nonprofits work together to make a difference in society that lasts.
              </p>
            </div>
            <div className="w-full rounded-xl mb-8" style={{ background: 'linear-gradient(90deg, #ffe4ef1a 0%, #fff 100%)' }}>
              <p className="text-base text-gray-700 text-center leading-relaxed py-4 font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
            ...
            <button 
              onClick={toggleModal}
              className="group relative px-8 py-4 text-white font-bold rounded-full shadow-md transition-all hover:shadow-lg hover:-translate-y-1 flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary font-sans"
      ...
      {/* Mission Banner - Modern Box with Rounded Corners and White Text */}
      <div className="w-full py-16 px-6 text-center shadow-inner relative overflow-hidden rounded-2xl" style={{ backgroundColor: COLORS.PRIMARY }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
          <h3 className="text-xl font-bold text-primary mb-6 font-sans" style={{ color: COLORS.PRIMARY, fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>Our Mission</h3>
          <div className="space-y-4 text-gray-700">
            {[
              ...
              <div key={idx} className="flex gap-3 items-start w-full rounded-xl" style={{ background: 'linear-gradient(90deg, #ffe4ef1a 0%, #fff 100%)' }}>
                <span className="font-bold text-lg mt-4 ml-4 font-sans" style={{ color: COLORS.PRIMARY, fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>›</span>
                <p className="leading-relaxed py-4 mr-4 font-sans" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>{mission}</p>
              </div>
            ))}
          </div>
        </div>
