...
const HomePage = ({ onNavigate }) => {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <SectionTitle className="mb-16" style={{ color: COLORS.PRIMARY }}>Our Core Causes</SectionTitle>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-center mb-12">
            <SectionTitle className="text-center" style={{ color: COLORS.PRIMARY }}>Our Stories</SectionTitle>
            <button 
