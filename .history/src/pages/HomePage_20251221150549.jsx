    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-center mb-10" style={{ color: COLORS.PRIMARY }}>What We Stand For</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
            <div className="flex flex-col items-center">
              <ResponsiveImage src={IMAGE_URLS.WHAT_WE_STAND_FOR_1} className="w-40 h-40 object-cover rounded-xl shadow mb-4" alt="Compassion & Community" />
              <span className="text-lg font-semibold text-gray-700">Compassion & Community</span>
            </div>
            <div className="flex flex-col items-center">
              <ResponsiveImage src={IMAGE_URLS.WHAT_WE_STAND_FOR_2} className="w-40 h-40 object-cover rounded-xl shadow mb-4" alt="Girl Child Education" />
              <span className="text-lg font-semibold text-gray-700">Girl Child Education</span>
            </div>
            <div className="flex flex-col items-center">
              <ResponsiveImage src={IMAGE_URLS.WHAT_WE_STAND_FOR_3} className="w-40 h-40 object-cover rounded-xl shadow mb-4" alt="Mental Health Awareness" />
              <span className="text-lg font-semibold text-gray-700">Mental Health Awareness</span>
            </div>
          </div>
        </div>
      </section>
