    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <PageSection bg="white">
        <div className="max-w-5xl mx-auto">
          <div className="relative rounded-3xl shadow-xl p-10 md:p-12 overflow-hidden group hover:shadow-2xl transition-all duration-300" style={{ background: 'linear-gradient(90deg, #ffe4ef1a 0%, #fff 100%)' }}>
