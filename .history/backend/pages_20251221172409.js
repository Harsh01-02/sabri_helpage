...
const pages = [
  // 1. HOME
  {
    slug: "home",
    title: "Home",
    meta: { description: "Sabri Helpage - Serving society for more than a decade through mental health support, elderly care, and girl child education." },
    updatedAt: "2025-12-20T10:30:00.000Z",
    sections: [
    // ...existing code...
  },
  // Ensure all other pages have meta
  // ...existing code...
].map(page => ({
  ...page,
  meta: page.meta && page.meta.description ? page.meta : { description: page.title || 'Sabri Helpage Page' }
}));
      {
        type: "hero",
      ...
      {
        type: "video",
        title: "Sabri Helpage Story",
        videoId: "YOUTUBE_VIDEO_ID",
        channelLink: "https://www.youtube.com/@sabrihelpage167",
        channelLabel: "Watch Our Stories"
      },
      {
        type: "causes",
        title: "Our Core Causes",
        subtitle: "Dedicated initiatives transforming lives across India",
        items: [
          {
            title: "Mental Health",
            description: "2,500+ sessions providing mental health support and counseling to those in need.",
            image: "/MentalHealth.jpg",
            route: "mental-health",
            stats: "2,500+ sessions"
          },
          {
            title: "Elderly Care",
            description: "1,200+ elders receiving compassionate care, medical support, and dignity.",
          ...
          },
          {
            ...
            description: "800+ girls empowered through education, scholarships, and mentorship programs.",
            image: "/girlChildEducation.jpg",
