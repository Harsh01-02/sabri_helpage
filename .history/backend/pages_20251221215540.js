  ...
  // 1. HOME
  {
    ...
    sections: [
        ...
        items: [
          {
            ...
            image: IMAGE_URLS.WHAT_WE_STAND_FOR_3,
            link: { label: "Learn More", targetSlug: "our-causes" }
          },
          {
            title: "Elderly Care",
            description: "Supporting abandoned seniors with medical camps, legal aid, and essential supplies.",
            image: IMAGE_URLS.WHAT_WE_STAND_FOR_1,
            link: { label: "Learn More", targetSlug: "our-causes" }
          },
          {
            title: "Girl Education",
            description: "Empowering street girls through education, hygiene kits, and vocational skills.",
            image: IMAGE_URLS.WHAT_WE_STAND_FOR_2,
            link: { label: "Learn More", targetSlug: "our-causes" }
          }
        ]
      },
        ...
        items: [
          {
            ...
            description: "Providing legal assistance to vulnerable communities."
          },
          {
            title: "Food Distribution",
            date: "Oct 15, 2025",
            image: IMAGE_URLS.NEWS_2_FOOD,
            description: "Distributing essential food supplies to families in need."
          },
          {
      ...
      },
      {
        ...
        backgroundImage: IMAGE_URLS.AWARDS_BACKGROUND,
        cta: { label: "Nominate a Changemaker", targetSlug: "sociofare" }
      },
      {
        type: "impact",
        title: "Our Impact",
        ...
        images: [
          IMAGE_URLS.CHILDREN_HAPPY,
          IMAGE_URLS.KIDS_LEARNING,
          IMAGE_URLS.COMMUNITY_SUPPORT
        ]
      }
    ]
  },
