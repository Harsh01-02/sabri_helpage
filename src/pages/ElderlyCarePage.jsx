...
const ElderlyCarePage = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: COLORS.BG_LIGHT_GRAY }}>
      <PageHeader title={pageData?.title || "Elderly Care"} subtitle={pageData?.sections?.find(s => s.type === "header")?.subtitle || "Dignity, Comfort, and Support for Seniors"} />
